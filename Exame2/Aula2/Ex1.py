...
predicts = regr.predict(X[train_inds,0:1])
from sklearn.metrics import mean_squared_error
val = mean_squared_error(predicts,X[train_inds,1:])

print(val)

predicts = regr.predict(X[test_inds,0:1])

val = mean_squared_error(predicts,X[test_inds,1:])

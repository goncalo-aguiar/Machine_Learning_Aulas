...
trained_predicted = regr.predict(X[train_inds,0:1])


from sklearn.metrics import mean_squared_error
# print(X[train_inds,1:])
print("\nTrainingError",mean_squared_error(trained_predicted , X[train_inds,1]))


test_predicted = regr.predict(X[test_inds,0:1])
print("\nTEstError",mean_squared_error(test_predicted , X[test_inds,1]))
